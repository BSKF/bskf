...
const FooterSection = () => {
    ...
    return (
        <footer className="bg-[#050505] pt-24 pb-12 px-6 border-t border-white/5 relative overflow-hidden text-white">
            <div className="max-w-7xl mx-auto relative z-10">
                {/* Massive CTA */}
                <div className="mb-32 text-center md:text-left">
                    <h2 className="text-[12vw] leading-none font-poppins font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20 tracking-tighter hover:tracking-wide transition-all duration-700 cursor-default select-none">
                        JOIN US
                    </h2>
                </div>
                ...
                <div className="grid md:grid-cols-4 gap-12 md:gap-24 mb-24">
                    <div className="md:col-span-2 space-y-6">
                        <h3 className="text-2xl font-poppins font-bold text-white">Digital Pathsala</h3>
                        <p className="text-gray-400 font-poppins max-w-sm leading-relaxed">
                        ...
                        <div className="flex gap-4 pt-4">
                            {[
                                ...
                                <a key={i} href={url} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#4ADE80] hover:text-black hover:scale-110 transition-all duration-300 group">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 font-poppins">
                            {['Our Story', 'Impact', 'Programs', 'Get Involved'].map((link) => (
                                <li key={link}>
                                    <a href="#" className="text-white hover:text-[#4ADE80] transition-colors flex items-center gap-2 group">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 gap-4">
                    ...
                    <button 
                        onClick={scrollToTop}
                        className="group flex items-center gap-2 text-white font-poppins text-sm uppercase tracking-widest hover:text-[#4ADE80] transition-colors"
                    >
                        Back to Top
                        <span className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center group-hover:border-[#4ADE80] group-hover:-translate-y-1 transition-all">
                            <ArrowUp size={14} />
                        </span>
                    </button>
                </div>
