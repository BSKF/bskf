...
const PublicationDetailPage = () => {
  ...
  // Mock data expanded for the detail view
  const publicationData: Record<string, any> = {
    "1": {
      ...
      heroImage: "https://images.unsplash.com/photo-1597626133663-53df9633b798?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      keyTakeaways: [
    ...
    // Add other detailed publications here...
  };
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-3">
                  {publication.keyTakeaways.map((highlight: string, index: number) => (
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold text-green-800 mb-4">Download Full Text</h3>
                <p className="text-gray-600 mb-4">
                  Access the complete publication for in-depth details.
                </p>
